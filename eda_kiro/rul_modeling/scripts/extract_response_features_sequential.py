"""
Extract response features from all capacitors and cycles (SEQUENTIAL VERSION).

This script extracts VL-VO response features from all ES12 capacitors
across all cycles using sequential processing for debugging.
"""
...
def extract_all_features_sequential():
    """Extract features from all capacitors sequentially."""
    print("="*80)
    print("RESPONSE FEATURE EXTRACTION (SEQUENTIAL)")
    print("="*80)
...
def main():
    """Main execution."""
    # Extract features
    df = extract_all_features_sequential()
